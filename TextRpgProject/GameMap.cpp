...
shared_ptr<Container> GameMap::Main()
{
    ...
    shared_ptr<TextBox> inventoryTitle = make_shared<TextBox>("  3. 인벤  ");
...
shared_ptr<Container> GameMap::SelectBattle()
{
    ...
    intTitle->move(0, 10);
    lukTitle->move(0, 12);
    attackTitle->move(17, 0);
    defenseTitle->move(17, 2);
    accuracyTitle->move(17, 4);
    skilldamageTitle->move(17, 6);
    criticalTitle->move(17, 8);
    expTitle->move(17, 10);
    goldTitle->move(17, 12);
    ...
    intBody->move(7, 10);
    lukBody->move(7, 12);
    attackBody->move(36, 0);
    defenseBody->move(36, 2);
    accuracyBody->move(36, 4);
    skilldamageBody->move(36, 6);
    criticalBody->move(36, 8);
    expBody->move(36, 10);
    goldBody->move(36, 12);
    levelBody->SetId(21);
    hpBody->SetId(22);
